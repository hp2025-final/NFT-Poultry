...
<body>
    <div class="header">
        <div class="report-title">Suppliers Summary Report</div>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="text-right">Total Purchases (Cr)</th>
                <th class="text-right">Total Payments (Dr)</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right bold {{ $l['closing'] > 0 ? 'text-danger' : '' }}">{{ number_format($l['closing'], 2) }}</td>
            </tr>
        ...
        <tfoot>
            <tr class="bold">
                <td colspan="4" class="text-right">TOTAL ACCOUNTS PAYABLE:</td>
